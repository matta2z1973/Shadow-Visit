...
import { uploadHostSchedules, type UploadResult } from "./actions";

const initial: UploadResult = { ok: false, message: "", perFile: [] };

export default function HostUploadForm() {
  const [state, action, pending] = useActionState(uploadHostSchedules, initial);
  ...
  return (
    <form action={action} className="mt-4">
      ...
      >
        {pending ? "Uploading…" : "Upload host schedules"}
      </button>
